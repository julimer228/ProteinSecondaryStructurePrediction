...
save_as_fasta(data$pred_class, "HCE", "HCE.fasta")
```
...
save_dataframe("CnotCHE.txt", data)
```
...
save_dataframe("HnotHCE.txt", data)
...
save_dataframe("EnotECH.txt", data)
```

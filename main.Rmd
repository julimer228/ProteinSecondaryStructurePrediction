...
# H/E
 test_samples$pred_class_HE <- predict(
   model_HE, test_samples[,8:ncol(test_samples)],type = "response");
 test_samples$pred_class_HE <- ifelse(
   test_samples$pred_class_HE >= 0.5, "1", "-1");
 
  ctab_test_HE <- table(test_samples$HE....HE, test_samples$pred_class_HE);

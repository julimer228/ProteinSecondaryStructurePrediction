...
# Train model
  ...
  saveRDS(model_HE, "model_HE13v2.rds");
# H/E
...
# Train model
  ...
  model_CH<-create_binary_model(train_samplesCH,train_samples$CH....CH);
  saveRDS(model_CH, "model_CH13.rds");
# C/H
